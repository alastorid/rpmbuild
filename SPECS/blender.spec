...
Obsoletes:	  fonts-blender < 1:2.68a-1

%description -n blender-fonts
...
%files -n blender-fonts
%defattr(-,root,root,-)
%{blender_fontdir}/
%doc release/datafiles/LICENSE-bmonofont-i18n.ttf.txt

%changelog
* Mon Nov 21 2016 Luya Tshimbalanga <luya@fedoraproject.org> - 1:2.68a-6
- Disable ode and OpenCollada
- Set python34 as build requirement
